...
typedef void (*plotdrawfilefn)(int scale,int originx,int originy,int x,int y,drawfile_diagram *drawfile,int size,Desk_wimp_box *cliprect);

extern plotdrawfilefn Graphics_PlotDrawfile;
